...
namespace Pantec.E3Proxy
{
    ...
    public sealed class E3JobProxy : E3ProxyBase, IAttributed
    {
        ...
        {
            return ComObject.DeactivateOptionIds(ids);
        }
        ...
        {
            return ComObject.GetAllConnectionIds(ids, flags);
        }
        ...
        {
            return ComObject.GetAllDeviceIds(ids);
        }

        public int GetAllOptionIds(ref object ids)
        {
            return ComObject.GetAllOptionIds(ids);
        }
        ...
        {
            return ComObject.GetAllSheetIds(ids);
        }
        ...
        {
            return ComObject.GetOptionAliases(ids);
        }
        ...
        {
            return ComObject.GetOptionIds(ids);
        }
        ...
        {
            return ComObject.GetOptionLockIDs(ids);
        }
        ...
        {
            return ComObject.GetOptionTerms(ids);
        }
        ...
        {
            return ComObject.GetOutdatedAllComponentIds(ids);
        }

        public int GetOutdatedCableTypeIds(ref object ids)
        {
            return ComObject.GetOutdatedCableTypeIds(ids);
        }

        public int GetOutdatedComponentIds(ref object ids)
        {
            return ComObject.GetOutdatedComponentIds(ids);
        }

        public int GetOutdatedSymbolTypeIds(ref object ids)
        {
            return ComObject.GetOutdatedSymbolTypeIds(ids);
        }

        public double GetOuterDiameter(ref object ids)
        {
            return ComObject.GetOuterDiameter(ids);
        }
        ...
        {
            return ComObject.GetSelectedDimensionIds(ids);
        }

        public int GetSelectedEmbeddedObjectIds(ref object ids)
        {
            return ComObject.GetSelectedEmbeddedObjectIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedGraphIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedNetSegmentIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedSheetIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedSignalIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedSymbolIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedTerminalIds(ids);
        }
        ...
        {
            return ComObject.GetSelectedTextIds(ids);
        }
        ...
        {
            return ComObject.GetSheetIds(ids);
        }
        ...
        {
            return ComObject.GetSignalClassIds(ids);
        }
        ...
        {
            return ComObject.GetSignalIds(ids);
        }
        ...
        {
            return ComObject.GetStructureNodeIds(ids);
        }

        public int GetSupplyIds(ref object ids)
        {
            return ComObject.GetSupplyIds(ids);
        }
        ...
        {
            return ComObject.GetSymbolIds(ids, symnam, level, view);
        }

        public int GetSymbolTypeIds(ref object ids)
        {
            return ComObject.GetSymbolTypeIds(ids);
        }
        ...
        {
            return ComObject.GetTerminalIds(ids);
        }
